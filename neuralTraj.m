...
%               xDims (default: false)
%
% brainregion - character string of the brain region recorded from for
% saving the run. (default: '')
%
% 2015 Karthik Lakshmanan     karthikl@cs.cmu.edu
% RWD added brain region argument for own saving purposes

datFormat            = 'spikes';
method               = 'gpfa';
binWidth             = 20; %this is in ms, update 2019-08-06 seems to throw an error for not enough obs if set to anything greater than 28
numFolds             = 0;
xDims                = [3];
...
runDir = sprintf(['mat_results/' brainregion 'run%03d'], runIdx);
if isdir(runDir)
